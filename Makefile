...
.PHONY: compose-up
compose-up: ##@Local Dev 	Start backend + frontend using Docker Compose
	docker-compose up --build

.PHONY: compose-down
compose-down: ##@Local Dev 	Stop all Docker containers
	docker-compose down

.PHONY: compose-logs
compose-logs: ##@Local Dev 	View logs for all containers
